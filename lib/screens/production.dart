...
// import 'package:stock/screens/Production_confirm.dart';

import 'confirm_production.dart';
          ...
          Padding(
            ...
            child: RaisedButton(
              ...
              onPressed: ()async{
                ...
                for(var v in map){
                  try{
                    await ProductionDb().insertProduction(v);
                  }catch(e){
                    print(e);
                  }
                }
                // await ProductionDb().giveList(DateTime.now().toString().split(" ")[0]);
...
//               onPressed: (){
//                 Navigator.pushNamed(context, '/cofirmProduction');
//               },
//             )
//           ],
//         ),
...
//               color: Color.fromRGBO(249,166,2,1),
//               onPressed: (){
//               Navigator.pushNamed(context, "/confirmProduction");
//               },
//             )
//           ],
//         ),
