...
class ConfirmProduction extends StatefulWidget {
  @override
  _ConfirmProductionState createState() => _ConfirmProductionState();
}

class _ConfirmProductionState extends State<ConfirmProduction> {
...
// class ConfirmProduction extends StatelessWidget {
//   @override
//   Widget build(BuildContext context) {
//     return Scaffold(
//       appBar: AppBar(
